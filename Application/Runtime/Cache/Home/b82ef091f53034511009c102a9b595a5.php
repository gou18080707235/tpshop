...
-->
	...
	<link rel="stylesheet" href="/Public/Home/style/layui.css" type="text/css">
	<script type="text/javascript" src="/Public/Home/js/home.js"></script>
		...
		<!-- 右侧内容区域 start -->
		<div class="content fl ml10" id="zhuti">
			<div class="address_hd" id="address">
				<h3>收货地址薄</h3>
				<dl>
