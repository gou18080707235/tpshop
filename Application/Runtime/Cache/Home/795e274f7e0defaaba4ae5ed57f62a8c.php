	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_left fl">
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<?php if(is_array($last_info)): foreach($last_info as $key=>$v): ?><li>
							<dl>
								<dt><a href=""><img src="<?php echo substr($v['goods_small_logo'],1);?>" alt="" /></a></dt>
			...
			<div class="summary">
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="shop_price"><span>会员价：</span> <strong>￥<?php echo ($goodsInfo['goods_member_price']); ?></strong> <a href="">(降价通知)</a></li>
