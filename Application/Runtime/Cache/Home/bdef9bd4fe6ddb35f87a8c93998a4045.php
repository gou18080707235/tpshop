				...
				<ul>
					<?php if(is_array($goodsInfo)): foreach($goodsInfo as $key=>$v): ?><li>
						<dl>
							...
							<dd><a href="<?php echo U('sec_kill',array('goods_id'=>$v['goods_id']));?>"><?php echo ($v['goods_name']); ?></a></dt>
							<dd><strong><?php echo ($v['goods_price']); ?></strong><br/>
								<strong>秒杀价：<?php echo ($v['kill_price']); ?></strong>
							</dt>
							<dd><a href=""><em><?php if(($v["nowtime"]) < $v['start_time']): ?>活动还没有开始呢<?php else: ?>活动已经开始了哦，请抓紧哦亲<?php endif; ?></em></a></dt>
						</dl>
