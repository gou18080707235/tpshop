	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
			<div class="login_form fl">
				...
				<div class="coagent mt15">
					<dl>
						...
						<dd class="weibo"><a href="<?php echo U('wb_login');?>"><span></span>新浪微博</a></dd>
			...
			<div class="guide fl">
				...
				<a href="regist.html" class="reg_btn" style="margin-bottom: 20px;">免费注册 >></a>

				<a href="<?php echo U('Home/User/fast_regist');?>" class="reg_btn">手机快速注册 >></a>
			</div>
