  ...
  <div id="center">
    ...
    <div id="center_middle">
      ...
      <div class="chknumber">
        ...
        <img src="/index.php/Admin/Manager/verifyImg" id="safecode" width="57" height="20" style="vertical-align: middle" onclick="this.src='verifyImg/'+Math.random()"/>
      </div>
    </div>
    ...
    <div id="center_right" style="color: #aa00aa"><?php echo ((isset($errorinfo) && ($errorinfo !== ""))?($errorinfo):'1'); ?></div>
  </div>
</form>
<div id="footer"></div>
</body>
