...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
    ...
    <tr>
        <td>
            <form action="/index.php/Admin/MemberLevel/addMember" method="post" >
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="general-tab-show">
                    ...
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left"><input type="text" name="level_rate"  id="level_rate"/></div></td>
                    </tr>
                    <tr>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">基本下限：</span></div></td>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left"><input type="text" name="jifen_bottom" id="jifen_bottom"/></div></td>
                    </tr>
                    <tr>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">积分上限：</span></div></td>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left"><input type="text" name="jifen_top"  id="jifen_top"/></div></td>
                    </tr>
                    <tr>
...
<script>
    $(function(){
        $('#tianjia').click(function(){
            ...
            //console.log(info);
            $.ajax({
                url:"/index.php/Admin/MemberLevel/addMember",
                type:'post',
                dataType:'json',
                data:info,
