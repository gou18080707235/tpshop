    ...
    <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
            ...
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                    ...
                    <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="left"><span class="STYLE19"><?php echo ($v['type_id']); ?></span></div></td>
                    <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="left"><span class="STYLE19"><?php echo ($v['type_name']); ?></span></div></td>
                    <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
                        <a href="<?php echo U('Attribute/showlist',array('type_id'=>$v['type_id']));?>"  style="color: darkmagenta"><img src="<?php echo C('AD_IMG_URL');?>del.gif" width="10" height="10" /> 属性列表 </a>| <span style="color: darkmagenta">查看</span> |
