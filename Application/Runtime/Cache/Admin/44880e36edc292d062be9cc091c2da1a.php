  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <?php if(is_array($info['list'])): foreach($info['list'] as $key=>$v): ?><tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><img src="<?php echo substr($v['goods_small_logo'],1);?>" alt="暂时没有LOGO" width="80"></div></td>
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
          ...
          <a href="<?php echo U('upd',array('goods_id'=>$v['goods_id']));?>" style="color: darkmagenta"> 编辑</a> | <a href="<?php echo U('staticHtml',array('goods_id'=>$v['goods_id']));?>">静态化</a> | <a href="<?php echo U('Kill/sec_kill',array('goods_id'=>$v['goods_id']));?>">秒杀</a></div></td>
