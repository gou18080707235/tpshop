    ...
    <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="show_attr">
            ...
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                    ...
                    <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="left"><span class="STYLE19"><?php echo ($v['attr_id']); ?></span></div></td>
                    <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="left"><span class="STYLE19"><?php echo ($v['attr_name']); ?></span></div></td>
