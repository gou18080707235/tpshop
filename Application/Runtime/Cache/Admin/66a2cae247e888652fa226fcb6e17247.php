    ...
    <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
            <tr>
                ...
                <td width="5%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">会员名称</span></div></td>
                <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">折扣率</span></div></td>
            ...
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                    ...
                    <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="left"><span class="STYLE19"><?php echo ($v['level_name']); ?></span></div></td>
                    <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="left"><span class="STYLE19"><?php echo ($v['level_rate']); ?></span></div></td>
                    <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($v['jifen_top']); ?></div></td>
                    <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($v['jifen_bottom']); ?></div></td>
                    <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
                        <a  onclick="if(confirm('您真的要删除这条信息吗？')){del(<?php echo ($v['id']); ?>)}" style="color: darkmagenta"><img src="<?php echo C('AD_IMG_URL');?>del.gif" width="10" height="10" /> 删除 </a>| <span style="color: darkmagenta">查看</span> |
                        <a href="<?php echo U('upd',array('id'=>$v['id']));?>" style="color: darkmagenta"><img src="<?php echo C('AD_IMG_URL');?>edit.gif" width="10" height="10"  /> 编辑</a></div></td>
...
<script>
    function del(id){
        alert(id);
        $.ajax({
            url:'/index.php/Admin/MemberLevel/del',
            data:{'id':id},
            dataType:'json',
            type:'get',
