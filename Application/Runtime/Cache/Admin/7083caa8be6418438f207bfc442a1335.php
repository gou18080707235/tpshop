    ...
    <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
            <tr>
                ...
                <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">角色IDS</span></div></td>
                <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">角色AC</span></div></td>
            ...
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                    ...
                    <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo ($v['role_name']); ?></span></div></td>
                    ...
                    <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
                        <a href="<?php echo U('distribute',array('role_id'=>$v['role_id']));?>" style="color: darkmagenta"><img src="<?php echo C('AD_IMG_URL');?>del.gif" width="10" height="10" /> 分配权限 </a>
                        <a href="<?php echo U('del',array('role_id'=>$v['role_id']));?>" onclick="return confirm('您真的要删除这条信息吗？')" style="color: darkmagenta"><img src="<?php echo C('AD_IMG_URL');?>del.gif" width="10" height="10" /> 删除 </a>| <span style="color: darkmagenta">查看</span> |
