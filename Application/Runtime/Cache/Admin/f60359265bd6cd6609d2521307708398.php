    ...
    <td>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="mix-tab-show" style="display:none">
          <?php if(is_array($memberInfo)): foreach($memberInfo as $key=>$vv): ?><tr>

            <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19"><?php echo ($vv['level_name']); ?>【<?php echo ($vv['level_rate']); ?>折】</span></div></td>
            <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
              <input type="text" name="goods_member[<?php echo ($vv['id']); ?>]" />
            </div></td>
